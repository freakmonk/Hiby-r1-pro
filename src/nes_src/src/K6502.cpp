...
// Absolute
static inline WORD Read_AA_ABS() { WORD l = K6502_Read(PC); PC++; WORD h = K6502_Read(PC); PC++; return (WORD)(l | (h << 8)); }
#define AA_ABS Read_AA_ABS()
// Absolute2 ( PC-- )
static inline WORD Read_AA_ABS2() { WORD l = K6502_Read(PC); PC++; WORD h = K6502_Read(PC); return (WORD)(l | (h << 8)); }
#define AA_ABS2 Read_AA_ABS2()
// Absolute,X
